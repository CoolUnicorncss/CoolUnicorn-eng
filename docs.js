elmnts = document.querySelectorAll("pre")

elmnts.forEach(function(item, index){
  CodeColor(item)
})
// hi
function CodeColor(elmnt, mode) {
  ...
  var attributevaluecolor = "#C68D75";
  var commentcolor = "#608B4E";
  var cssselectorcolor = "white";
  var csspropertycolor = "white";
  var csspropertyvaluecolor = "white";
  var cssdelimitercolor = "white";
  var cssimportantcolor = "white";  
  var jscolor = "white";
  var jskeywordcolor = "white";
  var jsstringcolor = "white";
  var jsnumbercolor = "white";
